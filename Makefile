...
TIMESCALEDB_TOOLKIT_EXTENSION?=forge-stable-1.3.0
TIMESCALEDB_TOOLKIT_EXTENSION_PREVIOUS?=forge-stable-0.3.0 forge-stable-1.0.0 forge-stable-1.1.0 forge-stable-1.2.0
