...
RUN echo 'deb http://archive.ubuntu.com/ubuntu kinetic main universe' >> /etc/apt/sources.list && \
    apt-get update && \
...
RUN TS_VERSIONS="1.7.5 2.1.0 2.1.1 2.2.0 2.2.1 2.3.0 2.3.1 2.4.0 2.4.1 2.4.2 2.5.0 2.5.1 2.5.2 2.6.0 2.6.1 2.7.0 2.7.1 2.7.2 2.8.0 2.8.1 2.9.0 2.9.1 2.9.2 2.9.3" \
